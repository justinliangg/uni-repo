...
public class MainWindow
{
    ...
    public void show()
    {
        ...
        ImageRecord firstImage = album.nextImage();
        String url = new File(firstImage.getFilename()).toURI().toString();
        ...
        captionWidget.setText(firstImage.getCaption());
    ...
    */
    ...
    {
        ImageRecord prevImage = album.prevImage();
        if(prevImage != null)
        {
    ...
    {   
        ImageRecord nextImage = album.nextImage();
        if(nextImage != null)
        {
