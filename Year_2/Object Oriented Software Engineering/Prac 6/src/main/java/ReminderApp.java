...
public class ReminderApp 
{
    ...
    public static void main(String[] args)
    {
        ...
        SwingUtilities.invokeLater(() -> 
        {
            ...
            AddReminderWindow addReminder = new AddReminderWindow(controller);
            MainWindow mainWindow = new MainWindow(controller, addReminder);
            remindersList.addObserver(mainWindow);
