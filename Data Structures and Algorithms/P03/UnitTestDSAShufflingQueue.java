/*-------------------------------                                               
FILE: UnitTestDSAShufflingQueue.java                                                    
Author: Justin Liang (19821986)                                                 
UNIT: DSA 
PURPOSE: Test DSAShufflingQueue Methods
REQUIRES: DSAQueue, DSAShufflingQueue                           
Last Mod: 12/08/2021                                                            
--------------------------------*/  
import java.io.*;

public class UnitTestDSAShufflingQueue
{
...
//==============================================================================
        ...
        DSAShufflingQueue test2 = null;
        System.out.println("\nTesting Parameter Constructor");
        try
        {
            numTests++;
            test2 = new DSAShufflingQueue(50);
            if(!test2.isEmpty())
            {
